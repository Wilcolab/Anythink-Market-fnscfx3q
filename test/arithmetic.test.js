...
// TODO: Challenge #1
    ...
    describe('Subtraction', function () {
        ...
        it('subtracts a floating point number', function (done) {
    ...
    describe('Power', function () {
        it('raises a positive integer to an integer exponent', function (done) {
        ...
        it('handles zero exponent', function (done) {
            request.get('/arithmetic?operation=power&operand1=7&operand2=0')
                .expect(200)
                .end(function (err, res) {
        ...
        it('handles fractional base', function (done) {
